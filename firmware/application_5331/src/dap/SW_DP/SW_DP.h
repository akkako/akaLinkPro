...
uint8_t SWD_Write_GPIO_ASM_40M(uint8_t header, uint32_t *data);
uint8_t SWD_Read_GPIO_ASM_40M(uint8_t header, uint32_t *data);
uint8_t SWD_Write_GPIO_ASM_48M(uint8_t header, uint32_t *data);
